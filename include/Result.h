 ...
 * 企业级应用加固组件 - 统一错误处理框架
 *
 * 本模块实现了零信任架构下定义的 ResultT<T> 模板结构体，
 ...
 * |------|--------|------|----------|
 * | SUCCESS | 0 | 操作成功 | 正常流程 |
 * | CLASS_A_AUTH_FATAL | 1 | 明确授权失败 | 弹窗提示，引导重新认证 |
 * | CLASS_B_RATE_LIMIT | 2 | 明确速率限制 | 显示冷却时间，禁用按钮 |
